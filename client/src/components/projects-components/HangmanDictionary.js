    ...
    <div className="projects u-margin-bottom-section">
      ...
      <div className="row">
        ...
        <p className="projects__description">
          ...
          you probably haven't heard of them chartreuse. Beard sriracha
        ...
        <p className="projects__description">
          ...
          slow-carb. Quinoa letterpress taxidermy bodega boys church-key tote
          bag cred actually shabby chic fam. Lo-fi cliche la croix truffaut
          90's.
        </p>
      </div>
    </div>
...
export default HangmanDictionary;
